...
if (page.url.indexOf('youtube.com/watch') != -1) {
  ...
  if (!ytPlayerWindow) {
	...
	player = {
	  ...
	  'playerWidth': 640,
	  'playerHeight': 390,
	  'playerWideWidth': 1440,
	  'playerWideHeight': 900,
...
// =====MetaCafe===== //
  ...
  if (!mcPlayerWindow) {
	...
	/* Create Player */
	var mcDefaultVideo = 'High Definition MP4';
	player = {
...
// =====Break===== //
  ...
  if (!brPlayerWindow) {
	...
	brVideoList['High Definition FLV'] = brVideo;
	brVideoPath = brVideoPath.replace(/\.flv/, '.mp4');
	brVideo = brVideoPath + '?' + brVideoToken;
	brVideoList['High Definition MP4'] = brVideo;
      }
      else {
	brVideo = brVideoPath + '?' + brVideoToken;
	brVideoList['High Definition MP4'] = brVideo;
